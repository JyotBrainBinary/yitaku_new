                        ...
                        GestureDetector(
                          ...
                          child: (dashboardController.currentTab == 1)
                            ...
                            children: [
                              ...
                              : Column(
                            children: [
                              Image.asset(AssetRes.searchBottom, height: 20, color: ColorRes.black,),
                              const SizedBox(height: 5),
                        ...
                        GestureDetector(
                          ...
                          child: (dashboardController.currentTab == 2)
                            ...
                            children: [
                              ...
                              const SizedBox(height: 5),
                              Text(StringRes.favorites, style: overpassRegular(
                                  fontSize: 12, color: ColorRes.fontGrey),),
                            ],
                          ),
                        ),
                        GestureDetector(
                          ...
                          child: (dashboardController.currentTab == 3)
                            ...
                            children: [
                              ...
                              const SizedBox(height: 5),
                              Text(StringRes.profile, style: overpassRegular(
                                  fontSize: 12, color: ColorRes.fontGrey),),
                            ],
                          ),
                        ),

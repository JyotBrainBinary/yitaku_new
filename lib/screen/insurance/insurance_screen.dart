              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        decoration: const BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(AssetRes.insuranceee))),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      SizedBox(
                          ...
                          child: const Text(
                            "  We're working hard to give you the best possible experience for all your insurance needs...",
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        "What kind of insurance policy would you be intersted in?",
                        style: TextStyle(color: Colors.grey, fontSize: 12.8),
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      ...
                      (controller.isDrop)
                          ? Container(
                              ...
                              child: Column(
                                children: List.generate(controller.item1.length,
                                    (index) {
                                  return InkWell(
                                      onTap: () {
                                        controller.isDrop = false;
                                        controller.selectItem =
                                            controller.item1[index];
                                        controller.update(["insurance"]);
                                      },
                                      child: Container(
                      ...
                      const Text(
                        "How would you like Yitaku to assist you in buying an insurance policy?",
                        style: TextStyle(color: Colors.grey, fontSize: 12.8),
                      ),
                      const SizedBox(
                        height: 10,
                      ...
                      (controller.isDrop2)
                          ? Container(
                              ...
                              child: Column(
                                children: List.generate(controller.item2.length,
                                    (index) {
                                  return InkWell(
                                    onTap: () {
                                      controller.isDrop2 = false;
                                      controller.selectItem2 =
                                          controller.item2[index];
                                      controller.update(["insurance"]);
                                    },
                                    child: Container(
                                      margin: const EdgeInsets.only(

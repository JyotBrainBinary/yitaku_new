                            ...
                            child: Row(
                              ...
                              children: [
                                (controller.pageIndex == 0)
                                  ...
                                  child: const Icon(Icons.arrow_back_ios_new_sharp, color: ColorRes.white, size: 12),
                                )
                                    : InkWell(
                                  onTap: (){
                                ...
                                (controller.pageIndex == controller.image.length - 1)
                                    ? Container(
                                    height: 20,
                                    width: 20,
                                    alignment: Alignment.center,
                                    ...
                                    child: const Icon(Icons.arrow_forward_ios_rounded, color: ColorRes.white, size: 12,)
                                )
                                    : InkWell(
                                  onTap: (){
                                    controller.pageIndex++;
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(StringRes.Apartment,  style: overpassRegular(color: ColorRes.hinttext, fontWeight: FontWeight.w500, fontSize: 16),),
            Container(
              height: 20,
              width: 80,
              alignment: Alignment.center,
              ...
              child: Text(StringRes.forSale, style: overpassRegular(color: ColorRes.color3879E8, fontWeight: FontWeight.w600, fontSize: 12),),
            ),
          ],
        ),
        const SizedBox(height: 5),
        Text("€ 240,000", style: overpassRegular(color: ColorRes.hinttext, fontSize: 22),),
        const SizedBox(height: 5),
        Row(
          children: [
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Row(
                  children: [
                    Image.asset(AssetRes.bathroom, height: 25, color: Colors.grey,),
                    const SizedBox(width: 8),
                    Text("2", style: overpassRegular(color: ColorRes.hinttext, fontSize: 16),),
                  ],
                ),
                Text(StringRes.bathroom, style: overpassRegular(color: Colors.grey, fontSize: 16),),
              ],
            ),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  children: [
                    Image.asset(AssetRes.zoomIn, height: 25, color: Colors.grey,),
                    const SizedBox(width: 8),
                    Text("93.7", style: overpassRegular(color: ColorRes.hinttext, fontSize: 16),),
                  ],
                ),
                Text("m2", style: overpassRegular(color: Colors.grey, fontSize: 16),),
              ],
            ),
          ],
        ),
        ...
        Row(
          children: [
            ...
            Text(StringRes.withTerrace, style: overpassRegular(color: ColorRes.hinttext, fontSize: 16),)
          ],
        ),
        const SizedBox(height: 15),
        Container(
    ...
    return Column(
     ...
     Padding(
       ...
       child: Column(
         crossAxisAlignment: CrossAxisAlignment.start,
         children: [
           Text(StringRes.seller, style: overpassRegular(color: ColorRes.fontGrey, fontSize: 22, fontWeight: FontWeight.w500),),
           ...
           Row(
             children: [
               ...
               Text("Rodianne - Owner", style: overpassRegular(color: ColorRes.hinttext),),
             ],
           ),
           const SizedBox(height: 10),
           Row(
             ...
             children: [
               Container(
                 ...
                 child: Text(StringRes.call, style: overpassRegular(color: ColorRes.white),),
               ),
               Container(
                 height: 40,
           ...
           Row(
             children: [
               Column(
                 crossAxisAlignment: CrossAxisAlignment.start,
                 children: [
                   Text(StringRes.loanAmount, style: overpassRegular(fontSize: 8, color: ColorRes.hinttext),),
                   const SizedBox(height: 3),
                   Text("€ 216,000", style: overpassRegular( color: ColorRes.hinttext),),
                 ],
               ),
               ...
               Column(
                 crossAxisAlignment: CrossAxisAlignment.start,
                 children: [
                   Text("${StringRes.deposit} (10%)", style: overpassRegular(fontSize: 8, color: ColorRes.hinttext),),
                   const SizedBox(height: 3),
                   Text("€ 24,000", style: overpassRegular( color: ColorRes.hinttext),),
                 ],
               ),
             ],
           ),
           ...
           Align(
             ...
             child: Container(
               ...
               child: Text(StringRes.howMuchCanIBorrow, style: overpassRegular(color: Colors.black),),
             ),
           ),
           const SizedBox(height: 10),
           Align(
             ...
             child: Container(
               ...
               child: Text(StringRes.compareHomeLoanOffers, style: overpassRegular(color: Colors.black),),
             ),
           ),
           SizedBox(height: Get.height * 0.05),
           Text(StringRes.otherPropertiesFromThisSeller, style: overpassRegular(color: ColorRes.hinttext),),
